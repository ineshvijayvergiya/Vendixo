...
const AdminLogin = () => {
  ...
  const handleAdminLogin = async (e) => {
    ...
    try {
      ...
      // 2. Simple Check: Kya ye Admin wali email hai?
      // (Asli app mein hum database mein role check karte hain, par abhi ke liye ye simple hack hai)
      if (email === "admin@techshed.com") {
         navigate('/admin/dashboard'); // Admin Dashboard pe bhejo
      } else {
         setError("Access Denied: You are not an Admin!");
         auth.signOut(); // Logout kar do agar admin nahi hai
      }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
      <div className="max-w-md w-full bg-gray-800 p-8 rounded-2xl shadow-2xl border border-gray-700">
        ...
        <p className="text-center text-gray-400 mb-8">Secure Access Only</p>
          ...
          <div>
            ...
            <div className="relative">
                <input 
                  ...
                  placeholder="admin@techshed.com" 
